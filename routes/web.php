...
use App\Http\Controllers\CustomerPortal\Report\CustomerReportsPdfController;
...
// Customer Portal Report PDF Endpoints
// ----------------------------------------------

Route::middleware(['auth:customer', 'customer-portal'])->prefix('customer/reports')->group(function () {
    // LR Receipts (sales) report for the authenticated customer
    Route::get('/lr-receipts', [CustomerReportsPdfController::class, 'lrReceipts']);

    // Payments report for the authenticated customer
    Route::get('/payments', [CustomerReportsPdfController::class, 'payments']);
});
