...
class CompanyService
{
    ...
    private function setupDefaultSettings(Company $company): void
    {
        ...
        $defaultOfficeInvoiceEmailBody = 'You have received a new invoice from <b>{COMPANY_NAME}</b>.</br> Please download using the button below:';
        $defaultLrReceiptEmailBody = 'You have received a new LR Receipt from <b>{COMPANY_NAME}</b>.</br> Please download using the button below:';

        $defaultLorryReceiptEmailBody = 'You have received a new Lorry Receipt from <b>{COMPANY_NAME}</b>.</br> Please download using the button below:';
        $defaultQuotationEmailBody = 'You have received a new quotation from <b>{COMPANY_NAME}</b>.</br> Please download using the button below:';
        ...
        $settings = [
            ...
            'office_invoice_mail_body' => $defaultOfficeInvoiceEmailBody,
            'lr_receipt_mail_body' => $defaultLrReceiptEmailBody,
            'lorry_receipt_mail_body' => $defaultLorryReceiptEmailBody,
            'quotation_mail_body' => $defaultQuotationEmailBody,
            ...
            'enable_standard_invoices' => 'NO',
            'enable_invoice_receipts' => 'NO',
            'enable_lr_receipts' => 'YES',
            'enable_lorry_receipts' => 'YES',
            'enable_warehouse_items' => 'YES',
            'enable_fleet_management' => 'YES',
            'enable_estimate' => 'NO',
            'enable_quotation' => 'NO',
        ];
