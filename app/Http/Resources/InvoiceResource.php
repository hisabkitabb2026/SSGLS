    ...
    public function toArray($request): array
    {
        return [
            ...
            'party_profile' => $this->whenLoaded('partyProfile', fn () => [
                ...
                'phone' => $this->partyProfile->phone,
                'address' => $this->partyProfile->address,
            ]),
            ...
            'dispatch_history' => $this->whenLoaded('warehouseItems', fn () => $this->warehouseItems->filter(fn ($item) => $item->loadTrip)->map(fn ($item) => ['trip_number' => $item->loadTrip->trip_number, 'truck_number' => $item->loadTrip->truck_number, 'driver_name' => $item->loadTrip->driver_name, 'status' => $item->loadTrip->status, 'dispatch_date' => $item->loadTrip->dispatch_date, 'actual_delivery_date' => $item->loadTrip->actual_delivery_date, 'weight_kg' => $item->weight_kg])->unique('trip_number')->values()),
        ];
    }
}
