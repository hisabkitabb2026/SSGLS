...
class PaymentsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $payments = Payment::whereCompany()
            ->with(['customer', 'currency', 'paymentMethod', 'invoice'])
    ...
    public function store(PaymentRequest $request)
    {
        ...
        $payment->load(['customer', 'currency', 'paymentMethod', 'fields.customField', 'company']);
    ...
    public function delete(DeletePaymentsRequest $request)
    {
        ...
        return $this->deleteBulk(Payment::class, $request->ids, $this->paymentService);
    }
