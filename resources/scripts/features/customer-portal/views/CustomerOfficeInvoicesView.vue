<template>
  <BasePage>
    <BasePageHeader title="Office Invoices">
      <template #default>
        <BaseBreadcrumb>
          <BaseBreadcrumbItem title="Home" to="customer-portal.dashboard" />
          <BaseBreadcrumbItem title="Office Invoices" to="#" active />
        </BaseBreadcrumb>
      </template>
    ...
    <div v-show="!showEmptyScreen" class="relative table-container">
      ...
      >
        <template #cell-invoice_number="{ row }">
          <router-link
            :to="buildPath(`office-invoices/${row.data.id}/view`)"
