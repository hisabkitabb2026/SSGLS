...
const reportUrl = computed<string>(() => {
  return `/customer/reports/lr-receipts?from_date=${formatDate(formData.from_date)}&to_date=${formatDate(formData.to_date)}`
})

onMounted(() => {
  url.value = reportUrl.value
})
  ...
  <div class="grid gap-8 md:grid-cols-12 pt-10">
    <div class="col-span-8 md:col-span-4">
      ...
      <div class="flex flex-col my-6 lg:space-x-3 lg:flex-row">
        ...
        <div
          class="hidden w-5 h-0 mx-4 border border-line-strong border-solid xl:block"
