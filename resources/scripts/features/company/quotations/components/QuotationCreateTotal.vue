<template>
  ...
  >
    ...
    >
      ...
      >{{ $t('quotations.total') }} {{ $t('quotations.amount') }}:</label>
...
import QuotationNetTotal from './QuotationNetTotal.vue'
import QuotationCreateTotalTaxes from './QuotationCreateTotalTaxes.vue'
import QuotationSelectTaxPopup from './QuotationSelectTaxPopup.vue'
