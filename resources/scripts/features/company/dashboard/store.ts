...
export interface DashboardStats {
  ...
  totalInvoiceReceiptCount: number
...
export const useDashboardStore = defineStore('dashboard', () => {
  ...
  async function loadData(params?: DashboardParams): Promise<DashboardResponse> {
    try {
      ...
      stats.value.totalInvoiceReceiptCount = response.total_invoice_receipt_count
      stats.value.totalEstimateCount = response.total_estimate_count
      stats.value.totalQuotationCount = response.total_quotation_count
