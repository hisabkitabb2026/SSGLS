...
/**
 * ExpiryDateSection — Generic expiry date settings component.
 *
 * Replaces EstimatesTabExpiryDate.vue and QuotationsTabExpiryDate.vue.
...
<template>
  <form @submit.prevent="submitForm">
    <BaseSwitchSection
      v-model="autoField"
      :title="t('settings.customization.set_expiry_date_automatically')"
      :description="t('settings.customization.set_expiry_date_automatically_description')"
    />

    <BaseInputGroup
      v-if="autoField"
      :label="t('settings.customization.expiry_date_days')"
