...
const modelTypes = reactive([
  ...
  { label: t('settings.custom_fields.model_type.quotation'), value: 'Quotation' },
  { label: t('settings.custom_fields.model_type.lr_receipt'), value: 'LrReceipt' },
  { label: t('settings.custom_fields.model_type.lorry_receipt'), value: 'LorryReceipt' },
  { label: t('settings.custom_fields.model_type.office_invoice'), value: 'OfficeInvoice' },
