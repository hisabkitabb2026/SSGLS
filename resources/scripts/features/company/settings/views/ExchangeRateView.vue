...
import ExchangeRateProviderModal from '@/scripts/features/company/settings/components/ExchangeRateProviderModal.vue'
  ...
  <BaseCard>
    ...
    <BaseTable ref="table" class="mt-16" :data="fetchData" :columns="drivers">
      ...
      <template #cell-active="{ row }">
        <BaseBadge
          :bg-color="row.data.active ? 'bg-status-green/10' : 'bg-surface-tertiary'"
          :color="row.data.active ? 'text-status-green' : 'text-muted'"
        >
