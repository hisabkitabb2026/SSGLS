      ...
      <BaseCard class="w-full">
        <BaseInputGrid layout="one-column">
          ...
          >
            ...
            >
              <template #action>
                <BaseSelectAction @mousedown.prevent="addItemUnit">
                  <BaseIcon
                    name="PlusIcon"
...
import ItemUnitModal from '../../settings/components/ItemUnitModal.vue'
...
async function loadData() {
  ...
  if (userStore.hasAbilities('view-tax-type')) {
    await fetchTaxTypes({ limit: 'all' })
  }
