    ...
    <form @submit.prevent="next">
      ...
      <div class="grid grid-cols-1 gap-4 mb-6 md:grid-cols-2">
        ...
        <BaseInputGroup :label="$t('settings.company_info.gstin')">
          <BaseInput v-model.trim="companyForm.gstin" type="text" name="gstin" />
        </BaseInputGroup>

        <BaseInputGroup :label="$t('settings.company_info.pan_no')">
          <BaseInput v-model.trim="companyForm.pan_no" type="text" name="pan_no" />
        </BaseInputGroup>

        <BaseInputGroup :label="$t('settings.company_info.enrollment_no')">
          <BaseInput v-model.trim="companyForm.enrollment_no" type="text" name="enrollment_no" />
        </BaseInputGroup>
      </div>
