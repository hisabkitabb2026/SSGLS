<template>
  ...
  >
    ...
    >
      ...
      <div @mousedown="closeDropdown" @click.stop>
        <slot name="action" />
      </div>
    </div>
...
const defaultClasses: Required<MultiselectClasses> = {
  ...
  containerInvalid:
    'border-alert-error-text ring-alert-error-text focus:ring-alert-error-text focus:border-alert-error-text',
  containerInvalidActive: 'ring-1 border-alert-error-text ring-alert-error-text',
  singleLabel:
